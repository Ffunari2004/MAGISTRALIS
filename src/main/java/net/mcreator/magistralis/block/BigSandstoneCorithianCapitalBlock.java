...
public class BigSandstoneCorithianCapitalBlock extends Block implements SimpleWaterloggedBlock {
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

	public BigSandstoneCorithianCapitalBlock() {
